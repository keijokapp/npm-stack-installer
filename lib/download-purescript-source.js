...
export default function downloadPurescriptSource(...args) {
	...
	if (argLen === 1) {
		return dlTar(`${defaultRevision}.tar.gz`, dir, defaultOptions);
	}
	...
	return dlTar(`${rev || defaultRevision}.tar.gz`, dir, { ...defaultOptions, ...options });
}
